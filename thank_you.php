                ...
                <div class="row">
                    <div class="col-md-7 mx-auto">
                        <div class="checkout-complete-content">
                            ...
                            <p>Your enquiry has been placed and will be processed as soon as possible. You will be receiving an email shortly with Revert 
                                of your order.</p>
                            <a href="shop.php" class="theme-btn">Go Back Shopping<i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
